	...
	<div class="wrapper">
			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/permission/findAll?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="${pageContext.request.contextPath}/permission/findAll?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>
								...
								<li><a href="${pageContext.request.contextPath}/permission/findAll?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
		...
		<script>
            function changePageSize() {
                ...
                //向服务器发送请求，改变没页显示条数
                location.href="${pageContext.request.contextPath}/permission/findAll?pageNum=1&pageSize="+pageSize;
            }
